...
import { fetchAllClinics, deleteClinic } from "../features/clinics/clinicSlice";
import { logout } from "../features/auth/authSlice";
import dummyImage from "../assets/images/dummyProfileImage.jpg";
import ExportClinicsExcel from "../components/ExportClinicsExcel";
...
function ClinicsManagement() {
  ...
  // ==================== FILTER ====================
  const filteredClinics = clinics?.filter((cln) =>
    cln?.clinicName?.toLowerCase().includes(searchQuery.toLowerCase())
  );
        ...
        <main className="p-4">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-3">
              ...
              <ExportClinicsExcel clinics={clinics} />
            </div>
          </div>
                      ...
                      >
                        ...
                        <td className="px-6 py-2">
                          <div className="flex items-center gap-8">
                            <img
                              src={clinic.profileImage || dummyImage}
                        ...
                        <td className="px-6 py-4 text-gray-700">
                          <div className="flex items-center gap-2">
                            ...
                            {clinic.suburbArea
                              ? `${clinic.suburbArea}, ${clinic.addressCity}`
                              : clinic.addressCity || "Not available"}
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex items-center justify-end space-x-2">
                            <button
                              onClick={() =>
                                navigate(`/clinics/edit/${clinic._id}`)
                              }
