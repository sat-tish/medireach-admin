        ...
        <main className="p-4">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-3">
              <button
                onClick={() => navigate("/success-stories/add")}
                className="flex items-center space-x-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700"
              >
                <Plus className="h-5 w-5" />
                <span>Add New Story</span>
              </button>
              <ExportSuccessStoriesExcel stories={stories} />
            </div>
          </div>
                      ...
                      >
                        ...
                        <td className="px-6 py-2">
                          <div className="flex items-center gap-8">
                            <img
                              src={story.successStoryImage || dummyImage}
                        ...
                        <td className="px-6 py-4 text-gray-700">
                          <div className="flex items-center gap-2">
                            ...
                            {story.successAuthor?.name || "Not specified"}
                          </div>
                        </td>
                        <td className="px-6 py-4 text-gray-700">
                          <div className="flex items-center gap-2">
                            <BookOpen className="h-4 w-4 text-blue-500" />
                            {story.successAuthor?.authorDesignation || "Not specified"}
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 text-gray-700">
                          <div className="flex items-center gap-2">
                            ...
                            {story.successAuthor?.suburbArea
                              ? `${story.successAuthor.suburbArea}, ${story.successAuthor.addressCity}`
                              : story.successAuthor?.addressCity ||
                                "Not available"}
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex items-center justify-end space-x-2">
                            <button
                              onClick={() =>
                                navigate(
                                  `/success-stories/edit/${story._id}`
                                )
                              }
